<html><head>
  ...
  <script type="text/javascript">
    ...
    var ws, name, client_list={},room_id,client_id,room_name;
    var room_list = ['all', 'color_fast', 'color_plain', 'color_slow', 'btc', 'eth'];
    room_id = getQueryString('room_id')?getQueryString('room_id'):1;
    room_name = room_list[room_id];
    ...
    function say(from_client_id, from_client_name, content, time){
    	...
    	$("#dialog").append('<div class="speech_item"><img src="https://p.qqan.com/up/2023-10/16965824774366453.jpg?'+from_client_id+'" width="30" height="30" class="user_icon" /> '+from_client_name+' <br> '+time+'<div style="clear:both;"></div><p class="triangle-isosceles top">'+content+'</p> </div>').parseEmotion();
    }
    ...
    <div class="container">
	    <div class="row clearfix">
	        ...
	        <div class="col-md-6 column">
               ...
               <div>
               &nbsp;&nbsp;&nbsp;&nbsp;<b>房间列表:</b>（当前在&nbsp;房间<script>document.write(room_name)</script>）<br>
               &nbsp;&nbsp;&nbsp;&nbsp;<a href="/Web?room_id=10">All</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Web?room_id=1">color_fast</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Web?room_id=2">color_plain</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Web?room_id=3">color_slow</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Web?room_id=4">btc</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Web?room_id=5">eth</a>
               <br><br>
               </div>
