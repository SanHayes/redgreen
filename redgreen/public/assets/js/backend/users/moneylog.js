define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'users/moneylog/index' + location.search,
                    add_url: 'users/moneylog/add',
                    edit_url: 'users/moneylog/edit',
                    del_url: 'users/moneylog/del',
                    multi_url: 'users/moneylog/multi',
                    table: 'users_money_log',
                }
            });
